...
$ \biggl (\begin{pmatrix}
    1 & 1  \\ 0 & 1
\end{pmatrix} - I \biggr) e_2 = e_1; \;  \biggl (\begin{pmatrix}
    1 & 1  \\ 0 & 1
\end{pmatrix} - I \biggr) e_1 = 0$ 
 \end{block}
 \end{frame}
...
\begin{block}{Allgemeine Lösung}
    ...
    \begin{align*}
        ...
        & \varphi_2(t) := e^t \biggl (I  +  \bigl (\begin{pmatrix} 1 & 1 \\ 0 & 1\end{pmatrix} - I\bigl)t \biggr )e_2 = e^t \begin{pmatrix} t  \\ 1 \end{pmatrix} \\
