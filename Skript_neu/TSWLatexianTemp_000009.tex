...
\begin{itemize}
  \item $\lambda$ Es gibt zwei verschiedene reelle Eigenwerte $\lmbda_1, \lambda_2$. 
		\\ Die allgemeine Lösung lautet dann
	    $\varphi(t) = c_1 e^{\lambda_1 t} v_1 +c_1 e^{\lambda_1 t} v_1 \; c_1, c_2 \in \mathbb{R}$	mit den Eigenvektoren $v_1, v_2$.
