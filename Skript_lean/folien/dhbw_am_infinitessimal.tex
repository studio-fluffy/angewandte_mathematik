...
\begin{frame}
    ...
    \begin{align}
        aTop := \bigcup_{n \in \mathbb{N}} M_n  \\
        M_n : = \{ m    \mid m \geq n\}
    \end{align}
\end{frame}
...
\begin{frame}
    ...
    \begin{align}
       F \in \mathcal{G} \; \forall F \in \mathcal{F}
    \end{align}
    ...
    \begin{align*}
            a: \mathbb{N} \rightarrow \mathbb{R}^n
            \end{align*}
    heißt konvergent gegen den Grenzwert $a \in \mathbb{R}^n$, wenn gilt:
    \begin{align}  
        MAP(m)(aTop) \leq  \mathcal{U}(a)
    \end{align}
\end{block}
