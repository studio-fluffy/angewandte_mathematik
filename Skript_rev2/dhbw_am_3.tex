...
Damit erhalten wir
\begin{align*}
& \lim_{n \to \infty} d(x_{n + m} , x_{ n})   \leq  \lim_{n \to \infty}  \lambda^n (\sum_{i=0}^m \lambda^i) d(x_{1} , d_{0} \\
& = \frac{\lambda^n (1- \lambda^m)}{1-\lambda}  d(x_{1} , d_{0}) \leq  \frac{\lambda^n}{1-\lambda}  d(x_{1} , d_{0}) 
\end{align*}
