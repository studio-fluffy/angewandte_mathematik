...
start, end = parent_index_map.local_range  # <-- Property, keine ()
parent_global_ids = np.arange(start, end, dtype=np.int64)

# ------------------------------------------------------------
# 3. Entity-Maps kombinieren
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# 5. Lokale Submesh-Zellen bestimmen
# ------------------------------------------------------------
...
# Kompatibel mit allen Dolfinx-Versionen
...
# ------------------------------------------------------------
# 6. Optional Meshtags übertragen und schreiben
# ------------------------------------------------------------
